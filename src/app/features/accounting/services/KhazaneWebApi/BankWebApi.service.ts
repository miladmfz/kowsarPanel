...
export class BankWebApiService {
  ...
  GetBank(command): Observable<any[]> {
    return this.withLoading(this.client.post<any[]>(this.baseUrl + "GetBank", command, { headers: this.headerService.headers }))
  }
