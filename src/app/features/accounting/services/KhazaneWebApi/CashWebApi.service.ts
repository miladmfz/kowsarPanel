...
export class CashWebApiService {
  ...
  constructor() {
    this.baseUrl = this.config.apiUrl + 'Cash/';
  ...
  GetCash(command): Observable<any[]> {
    return this.withLoading(this.client.post<any[]>(this.baseUrl + "GetCash", command, { headers: this.headerService.headers }))
  }
