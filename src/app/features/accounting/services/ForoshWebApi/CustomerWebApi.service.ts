...
export class CustomerWebApiService {
  ...
  constructor() {
    this.baseUrl = this.config.apiUrl + 'Customer/';
  ...
  GetCustomer(command): Observable<any[]> {
    return this.withLoading(this.client.post<any[]>(this.baseUrl + "GetCustomer", command, { headers: this.headerService.headers }))
  }
