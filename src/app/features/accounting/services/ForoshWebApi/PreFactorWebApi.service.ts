...
export class PreFactorWebApiService {
  ...
  constructor() {
    this.baseUrl = this.config.apiUrl + 'PreFactor/';
  ...
  UpdatePreFactorPFState(command): Observable<any[]> {
    return this.withLoading(this.client.post<any[]>(this.baseUrl + "UpdatePreFactorPFState", command, { headers: this.headerService.headers }))
  }
  ...
  DeleteWebPreFactorRows(FactorRowCode: string): Observable<any[]> {
    ...
    return this.withLoading(this.client.get<any[]>(this.baseUrl + "DeleteWebPreFactorRows", { headers: this.headerService.headers, params: params }))
  }
  DeleteWebPreFactor(FactorCode: string): Observable<any[]> {
    const params = new HttpParams().append('PreFactorCode', FactorCode)
    return this.withLoading(this.client.get<any[]>(this.baseUrl + "DeleteWebPreFactor", { headers: this.headerService.headers, params: params }))
  }
  ...
  GetSupportFactors(command): Observable<any[]> {
    ...
    return this.withLoading(this.client.post<any[]>(this.baseUrl + "GetSupportFactors", command, { headers: this.headerService.headers }))
