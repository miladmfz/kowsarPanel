...
export class StackWebApiService {
  ...
  constructor() {
    this.baseUrl = this.config.apiUrl + 'Stack/';
  ...
  StacksCrudService(command): Observable<any[]> {

    return this.withLoading(this.client.post<any[]>(this.baseUrl + "StacksCrudService", command, { headers: this.headerService.headers }))
