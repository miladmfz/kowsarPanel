...
export class VendorWebApiService {
  ...
  constructor() {
    this.baseUrl = this.config.apiUrl + 'Vendor/';
  ...
  GetVendor(command): Observable<any[]> {
    return this.withLoading(this.client.post<any[]>(this.baseUrl + "GetVendor", command, { headers: this.headerService.headers }))
  }
