...
export class JobWebApiService {
  ...
  constructor() {
    this.baseUrl = this.config.apiUrl + 'Job/';
  ...
  GetJob(command): Observable<any[]> {
    return this.withLoading(this.client.post<any[]>(this.baseUrl + "GetJob", command, { headers: this.headerService.headers }))
  }
