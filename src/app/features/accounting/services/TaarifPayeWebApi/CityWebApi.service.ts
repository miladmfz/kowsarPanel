...
export class CityWebApiService {
  ...
  constructor() {
    this.baseUrl = this.config.apiUrl + 'City/';
  ...
  CityCrudService(command): Observable<any[]> {

    return this.withLoading(this.client.post<any[]>(this.baseUrl + "CityCrudService", command, { headers: this.headerService.headers }))
