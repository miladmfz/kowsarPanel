...
export class AccKolWebApiService {
  ...
  constructor() {
    this.baseUrl = this.config.apiUrl + 'AccKol/';
  ...
  GetAccKol(command): Observable<any[]> {
    return this.withLoading(this.client.post<any[]>(this.baseUrl + "GetAccKol", command, { headers: this.headerService.headers }))
  }
