...
export class FactorWebApiService {
  ...
  UpdateFactorInvoiceState(command): Observable<any[]> {
    return this.withLoading(this.client.post<any[]>(this.baseUrl + "UpdateFactorInvoiceState", command, { headers: this.headers }))
  }
  ...
  DeleteWebFactorRows(FactorRowCode: string): Observable<any[]> {
    ...
    return this.withLoading(this.client.get<any[]>(this.baseUrl + "DeleteWebFactorRows", { headers: this.headers, params: params }))
  }
  DeleteWebFactor(FactorCode: string): Observable<any[]> {
    const params = new HttpParams().append('FactorCode', FactorCode)
    return this.withLoading(this.client.get<any[]>(this.baseUrl + "DeleteWebFactor", { headers: this.headers, params: params }))
  }
  ...
  GetFactors(command): Observable<any[]> {
    ...
    return this.withLoading(this.client.post<any[]>(this.baseUrl + "GetFactors", { headers: this.headers }))
