...
export class DbSetupWebApiService {
  ...
  GetDbSetup(command): Observable<any[]> {
    return this.withLoading(this.client.post<any[]>(this.baseUrl + "GetDbSetup", command, { headers: this.headers }))
  }
  ...
  UpdateDbSetup(command): Observable<any[]> {
    return this.withLoading(this.client.post<any[]>(this.baseUrl + "UpdateDbSetup", command, { headers: this.headers }))
  }
