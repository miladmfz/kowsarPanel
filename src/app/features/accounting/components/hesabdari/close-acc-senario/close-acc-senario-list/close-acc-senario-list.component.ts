...
import { CloseAccSenarioWebApiService } from 'src/app/features/accounting/services/HesabdariWebApi/CloseAccSenarioWebApi.service';
@Component({
  standalone: true,
  imports: [
    CommonModule,
...
export class CloseAccSenarioListComponent extends AgGridBaseComponent
  ...
  title = signal('فرآیند انتقال حساب')
