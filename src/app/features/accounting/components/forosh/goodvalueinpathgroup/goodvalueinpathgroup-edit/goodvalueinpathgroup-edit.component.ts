...
@Component({
  ...
  selector: 'app-goodvalueinpathgroup-edit',
  templateUrl: './goodvalueinpathgroup-edit.component.html',
})
export class GoodvalueinpathgroupEditComponent implements OnInit {
