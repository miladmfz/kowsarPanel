...
@Component({
  ...
  selector: 'app-cafe-resturant-factor-edit',
  templateUrl: './cafe-resturant-factor-edit.component.html',
})
export class CafeResturantFactorEditComponent implements OnInit {
