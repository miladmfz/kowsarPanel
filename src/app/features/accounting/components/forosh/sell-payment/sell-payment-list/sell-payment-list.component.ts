...
import { SellPaymentWebApiService } from 'src/app/features/accounting/services/ForoshWebApi/SellPaymentWebApi.service';
@Component({
  standalone: true,
  imports: [
    CommonModule,
  ...
  selector: 'app-sell-payment-list',
  templateUrl: './sell-payment-list.component.html',
})
export class SellPaymentListComponent extends AgGridBaseComponent
  implements OnInit, OnDestroy {
  private readonly router = inject(Router);
  private readonly notificationService = inject(NotificationService);

  private readonly repo = inject(SellPaymentWebApiService);
  ...
  GetData() {
    ...
    this.repo.GetSellPayment(this.EditForm_Search.value)
      .subscribe((data: any) => {

        this.records.set(data.SellPayments)
