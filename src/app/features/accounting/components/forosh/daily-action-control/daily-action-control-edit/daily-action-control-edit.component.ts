...
@Component({
  ...
  selector: 'app-daily-action-control-edit',
  templateUrl: './daily-action-control-edit.component.html',
})
export class DailyActionControlEditComponent implements OnInit {
