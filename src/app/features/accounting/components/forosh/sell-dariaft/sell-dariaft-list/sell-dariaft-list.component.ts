...
import { SellDariaftWebApiService } from 'src/app/features/accounting/services/ForoshWebApi/SellDariaftWebApi.service';
@Component({
  standalone: true,
  imports: [
    CommonModule,
  ...
  selector: 'app-sell-dariaft-list',
  templateUrl: './sell-dariaft-list.component.html',
})
export class SellDariaftListComponent extends AgGridBaseComponent
  implements OnInit, OnDestroy {
  private readonly router = inject(Router);
  private readonly notificationService = inject(NotificationService);

  private readonly repo = inject(SellDariaftWebApiService);
  ...
  GetData() {
    ...
    this.repo.GetSellDariaft(this.EditForm_Search.value)
      .subscribe((data: any) => {

        this.records.set(data.SellDariafts)
