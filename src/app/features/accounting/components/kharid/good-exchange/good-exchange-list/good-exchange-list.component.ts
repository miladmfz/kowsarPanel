...
import { GoodExchangeWebApiService } from 'src/app/features/accounting/services/KharidWebApi/GoodExchangeWebApi.service';
@Component({
  standalone: true,
  imports: [
    CommonModule,
  ...
  selector: 'app-good-exchange-list',
  templateUrl: './good-exchange-list.component.html',
})
export class GoodExchangeListComponent extends AgGridBaseComponent
  implements OnInit, OnDestroy {
  private readonly router = inject(Router);
  private readonly notificationService = inject(NotificationService);

  private readonly repo = inject(GoodExchangeWebApiService);
  ...
  GetData() {
    ...
    this.repo.GetGoodExchange(this.EditForm_Search.value)
      .subscribe((data: any) => {

        this.records.set(data.GoodExchanges)
