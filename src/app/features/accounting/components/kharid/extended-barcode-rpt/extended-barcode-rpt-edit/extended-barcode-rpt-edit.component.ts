...
@Component({
  ...
  selector: 'app-extended-barcode-rpt-edit',
  templateUrl: './extended-barcode-rpt-edit.component.html',
})
export class ExtendedBarcodeRptEditComponent implements OnInit {
