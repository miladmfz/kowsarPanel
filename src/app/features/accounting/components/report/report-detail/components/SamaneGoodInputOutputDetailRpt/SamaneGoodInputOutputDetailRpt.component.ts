...
@Component({
  ...
  selector: 'app-SamaneGoodInputOutputDetailRpt',
  templateUrl: './SamaneGoodInputOutputDetailRpt.component.html',
})
export class SamaneGoodInputOutputDetailRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
