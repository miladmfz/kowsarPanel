...
@Component({
  ...
  selector: 'app-CustomerPaymentGroupRpt',
  templateUrl: './CustomerPaymentGroupRpt.component.html',
})
export class CustomerPaymentGroupRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
