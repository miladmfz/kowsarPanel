...
@Component({
  ...
  selector: 'app-TcPrintReturnPurchaseRpt',
  templateUrl: './TcPrintReturnPurchaseRpt.component.html',
})
export class TcPrintReturnPurchaseRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
