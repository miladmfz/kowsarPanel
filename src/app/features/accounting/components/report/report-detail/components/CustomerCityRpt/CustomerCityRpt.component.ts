...
@Component({
  ...
  selector: 'app-CustomerCityRpt',
  templateUrl: './CustomerCityRpt.component.html',
})
export class CustomerCityRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
