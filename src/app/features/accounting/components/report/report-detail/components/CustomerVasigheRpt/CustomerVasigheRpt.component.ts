...
@Component({
  ...
  selector: 'app-CustomerVasigheRpt',
  templateUrl: './CustomerVasigheRpt.component.html',
})
export class CustomerVasigheRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
