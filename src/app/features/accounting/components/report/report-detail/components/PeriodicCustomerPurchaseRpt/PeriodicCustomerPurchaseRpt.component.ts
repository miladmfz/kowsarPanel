...
@Component({
  ...
  selector: 'app-PeriodicCustomerPurchaseRpt',
  templateUrl: './PeriodicCustomerPurchaseRpt.component.html',
})
export class PeriodicCustomerPurchaseRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
