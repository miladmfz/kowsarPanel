...
@Component({
  ...
  selector: 'app-GoodKardexRpt',
  templateUrl: './GoodKardexRpt.component.html',
})
export class GoodKardexRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
