...
@Component({
  ...
  selector: 'app-CustomerWithoutGoodRpt',
  templateUrl: './CustomerWithoutGoodRpt.component.html',
})
export class CustomerWithoutGoodRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
