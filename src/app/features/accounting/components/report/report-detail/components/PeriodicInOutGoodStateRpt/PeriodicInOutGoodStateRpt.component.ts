...
@Component({
  ...
  templateUrl: './PeriodicInOutGoodStateRpt.component.html',
})
export class PeriodicInOutGoodStateRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
