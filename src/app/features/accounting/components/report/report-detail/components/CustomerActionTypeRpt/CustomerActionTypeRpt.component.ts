...
@Component({
  ...
  selector: 'app-CustomerActionTypeRpt',
  templateUrl: './CustomerActionTypeRpt.component.html',
})
export class CustomerActionTypeRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
