...
@Component({
  ...
  selector: 'app-KardexRialyRpt',
  templateUrl: './KardexRialyRpt.component.html',
})
export class KardexRialyRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
