...
@Component({
  ...
  selector: 'app-CustomerIdentificationEtebarRpt',
  templateUrl: './CustomerIdentificationEtebarRpt.component.html',
})
export class CustomerIdentificationEtebarRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
