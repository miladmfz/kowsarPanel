...
@Component({
  ...
  selector: 'app-TcPrintReturnFactorRpt',
  templateUrl: './TcPrintReturnFactorRpt.component.html',
})
export class TcPrintReturnFactorRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
