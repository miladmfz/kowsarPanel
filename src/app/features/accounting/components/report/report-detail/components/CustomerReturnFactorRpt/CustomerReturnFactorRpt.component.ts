...
@Component({
  ...
  selector: 'app-CustomerReturnFactorRpt',
  templateUrl: './CustomerReturnFactorRpt.component.html',
})
export class CustomerReturnFactorRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
