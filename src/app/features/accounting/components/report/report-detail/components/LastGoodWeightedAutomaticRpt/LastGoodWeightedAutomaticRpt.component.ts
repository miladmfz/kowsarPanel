...
@Component({
  ...
  selector: 'app-LastGoodWeightedAutomaticRpt',
  templateUrl: './LastGoodWeightedAutomaticRpt.component.html',
})
export class LastGoodWeightedAutomaticRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
