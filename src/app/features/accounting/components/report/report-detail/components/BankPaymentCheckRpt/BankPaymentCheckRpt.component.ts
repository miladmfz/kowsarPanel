...
@Component({
  ...
  selector: 'app-BankPaymentCheckRpt',
  templateUrl: './BankPaymentCheckRpt.component.html',
})
export class BankPaymentCheckRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
