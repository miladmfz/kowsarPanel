...
@Component({
  ...
  selector: 'app-CustomerReceiveGroupRpt',
  templateUrl: './CustomerReceiveGroupRpt.component.html',
})
export class CustomerReceiveGroupRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
