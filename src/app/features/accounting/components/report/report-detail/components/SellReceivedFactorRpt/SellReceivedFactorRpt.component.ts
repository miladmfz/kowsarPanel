...
@Component({
  ...
  selector: 'app-SellReceivedFactorRpt',
  templateUrl: './SellReceivedFactorRpt.component.html',
})
export class SellReceivedFactorRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
