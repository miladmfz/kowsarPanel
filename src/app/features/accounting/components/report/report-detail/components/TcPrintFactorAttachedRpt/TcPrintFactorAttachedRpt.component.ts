...
@Component({
  ...
  selector: 'app-TcPrintFactorAttachedRpt',
  templateUrl: './TcPrintFactorAttachedRpt.component.html',
})
export class TcPrintFactorAttachedRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
