...
@Component({
  ...
  templateUrl: './PeriodicCustomerPurchaseSeparateRpt.component.html',
})
export class PeriodicCustomerPurchaseSeparateRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
