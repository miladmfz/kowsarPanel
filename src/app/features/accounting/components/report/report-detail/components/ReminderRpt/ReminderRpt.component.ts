...
@Component({
  ...
  selector: 'app-ReminderRpt',
  templateUrl: './ReminderRpt.component.html',
})
export class ReminderRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
