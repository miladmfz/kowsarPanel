...
@Component({
  ...
  selector: 'app-CustomerFactor_SanadTypeRpt',
  templateUrl: './CustomerFactor_SanadTypeRpt.component.html',
})
export class CustomerFactor_SanadTypeRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
