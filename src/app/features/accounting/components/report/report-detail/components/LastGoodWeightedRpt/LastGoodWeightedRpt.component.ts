...
@Component({
  ...
  selector: 'app-LastGoodWeightedRpt',
  templateUrl: './LastGoodWeightedRpt.component.html',
})
export class LastGoodWeightedRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
