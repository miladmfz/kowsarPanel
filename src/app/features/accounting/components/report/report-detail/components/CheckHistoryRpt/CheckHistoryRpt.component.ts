...
@Component({
  ...
  selector: 'app-CheckHistoryRpt',
  templateUrl: './CheckHistoryRpt.component.html',
})
export class CheckHistoryRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
