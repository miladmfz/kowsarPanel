...
@Component({
  ...
  selector: 'app-SellStackGroupingRpt',
  templateUrl: './SellStackGroupingRpt.component.html',
})
export class SellStackGroupingRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
