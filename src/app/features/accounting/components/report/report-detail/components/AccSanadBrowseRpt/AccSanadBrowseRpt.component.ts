...
@Component({
  ...
  selector: 'app-AccSanadBrowseRpt',
  templateUrl: './AccSanadBrowseRpt.component.html',
})
export class AccSanadBrowseRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
