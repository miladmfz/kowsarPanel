...
@Component({
  ...
  selector: 'app-CustomerReceiveRpt',
  templateUrl: './CustomerReceiveRpt.component.html',
})
export class CustomerReceiveRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
