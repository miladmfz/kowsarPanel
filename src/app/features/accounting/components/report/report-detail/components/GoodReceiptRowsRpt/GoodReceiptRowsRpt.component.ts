...
@Component({
  ...
  selector: 'app-GoodReceiptRowsRpt',
  templateUrl: './GoodReceiptRowsRpt.component.html',
})
export class GoodReceiptRowsRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
