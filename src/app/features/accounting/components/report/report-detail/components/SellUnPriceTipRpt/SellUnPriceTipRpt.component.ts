...
@Component({
  ...
  selector: 'app-SellUnPriceTipRpt',
  templateUrl: './SellUnPriceTipRpt.component.html',
})
export class SellUnPriceTipRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
