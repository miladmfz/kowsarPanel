...
@Component({
  ...
  selector: 'app-GoodSerialAmountControlRpt',
  templateUrl: './GoodSerialAmountControlRpt.component.html',
})
export class GoodSerialAmountControlRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
