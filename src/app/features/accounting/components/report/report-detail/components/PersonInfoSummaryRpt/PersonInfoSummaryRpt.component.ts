...
@Component({
  ...
  selector: 'app-PersonInfoSummaryRpt',
  templateUrl: './PersonInfoSummaryRpt.component.html',
})
export class PersonInfoSummaryRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
