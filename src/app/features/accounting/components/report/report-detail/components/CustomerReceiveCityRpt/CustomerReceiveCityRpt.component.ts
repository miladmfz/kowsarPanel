...
@Component({
  ...
  selector: 'app-CustomerReceiveCityRpt',
  templateUrl: './CustomerReceiveCityRpt.component.html',
})
export class CustomerReceiveCityRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
