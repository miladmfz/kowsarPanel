...
@Component({
  ...
  selector: 'app-PeriodicCustomerDailyPurchaseCashRpt',
  templateUrl: './PeriodicCustomerDailyPurchaseCashRpt.component.html',
})
export class PeriodicCustomerDailyPurchaseCashRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
