...
@Component({
  ...
  selector: 'app-CustomerPaymentCityRpt',
  templateUrl: './CustomerPaymentCityRpt.component.html',
})
export class CustomerPaymentCityRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
