...
@Component({
  ...
  selector: 'app-GoodCycleWithStackRpt',
  templateUrl: './GoodCycleWithStackRpt.component.html',
})
export class GoodCycleWithStackRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
