...
@Component({
  ...
  selector: 'app-LastGoodSubCodeHistoryRpt',
  templateUrl: './LastGoodSubCodeHistoryRpt.component.html',
})
export class LastGoodSubCodeHistoryRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
