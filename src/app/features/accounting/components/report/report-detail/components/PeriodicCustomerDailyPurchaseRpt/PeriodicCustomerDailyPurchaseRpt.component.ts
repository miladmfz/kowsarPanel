...
@Component({
  ...
  selector: 'app-PeriodicCustomerDailyPurchaseRpt',
  templateUrl: './PeriodicCustomerDailyPurchaseRpt.component.html',
})
export class PeriodicCustomerDailyPurchaseRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
