...
@Component({
  ...
  selector: 'app-ReturnFactorRowsRpt',
  templateUrl: './ReturnFactorRowsRpt.component.html',
})
export class ReturnFactorRowsRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
