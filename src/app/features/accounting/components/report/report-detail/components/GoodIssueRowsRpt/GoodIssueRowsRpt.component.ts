...
@Component({
  ...
  selector: 'app-GoodIssueRowsRpt',
  templateUrl: './GoodIssueRowsRpt.component.html',
})
export class GoodIssueRowsRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
