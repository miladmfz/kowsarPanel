...
@Component({
  ...
  selector: 'app-CustomerForoshCityRpt',
  templateUrl: './CustomerForoshCityRpt.component.html',
})
export class CustomerForoshCityRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
