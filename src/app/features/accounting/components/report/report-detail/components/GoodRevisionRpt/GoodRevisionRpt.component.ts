...
@Component({
  ...
  selector: 'app-GoodRevisionRpt',
  templateUrl: './GoodRevisionRpt.component.html',
})
export class GoodRevisionRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
