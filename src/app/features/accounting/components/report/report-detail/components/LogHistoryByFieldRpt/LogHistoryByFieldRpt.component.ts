...
@Component({
  ...
  selector: 'app-LogHistoryByFieldRpt',
  templateUrl: './LogHistoryByFieldRpt.component.html',
})
export class LogHistoryByFieldRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
