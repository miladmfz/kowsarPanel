...
@Component({
  ...
  selector: 'app-StackTransferRowRpt',
  templateUrl: './StackTransferRowRpt.component.html',
})
export class StackTransferRowRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
