...
@Component({
  ...
  selector: 'app-TcPrintFactorRpt',
  templateUrl: './TcPrintFactorRpt.component.html',
})
export class TcPrintFactorRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
