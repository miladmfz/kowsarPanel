...
@Component({
  ...
  selector: 'app-StackTransferRpt',
  templateUrl: './StackTransferRpt.component.html',
})
export class StackTransferRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
