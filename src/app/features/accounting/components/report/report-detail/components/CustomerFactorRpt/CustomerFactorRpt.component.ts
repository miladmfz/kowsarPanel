...
@Component({
  ...
  selector: 'app-CustomerFactorRpt',
  templateUrl: './CustomerFactorRpt.component.html',
})
export class CustomerFactorRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
