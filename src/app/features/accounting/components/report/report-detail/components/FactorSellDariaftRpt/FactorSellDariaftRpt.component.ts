...
@Component({
  ...
  selector: 'app-FactorSellDariaftRpt',
  templateUrl: './FactorSellDariaftRpt.component.html',
})
export class FactorSellDariaftRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
