...
@Component({
  ...
  selector: 'app-StackSellRpt',
  templateUrl: './StackSellRpt.component.html',
})
export class StackSellRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
