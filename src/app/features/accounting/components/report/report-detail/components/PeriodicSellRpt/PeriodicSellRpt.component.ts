...
@Component({
  ...
  selector: 'app-PeriodicSellRpt',
  templateUrl: './PeriodicSellRpt.component.html',
})
export class PeriodicSellRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
