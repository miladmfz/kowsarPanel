...
@Component({
  ...
  selector: 'app-CustomerPreFactorRpt',
  templateUrl: './CustomerPreFactorRpt.component.html',
})
export class CustomerPreFactorRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
