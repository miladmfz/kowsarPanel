...
@Component({
  ...
  selector: 'app-GoodSellSerialsRpt',
  templateUrl: './GoodSellSerialsRpt.component.html',
})
export class GoodSellSerialsRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
