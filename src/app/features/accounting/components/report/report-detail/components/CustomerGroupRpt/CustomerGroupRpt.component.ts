...
@Component({
  ...
  selector: 'app-CustomerGroupRpt',
  templateUrl: './CustomerGroupRpt.component.html',
})
export class CustomerGroupRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
