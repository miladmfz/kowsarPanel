...
@Component({
  ...
  selector: 'app-BulletinCitySellRpt',
  templateUrl: './BulletinCitySellRpt.component.html',
})
export class BulletinCitySellRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
