...
@Component({
  ...
  selector: 'app-BazaryabKarkardRpt',
  templateUrl: './BazaryabKarkardRpt.component.html',
})
export class BazaryabKarkardRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
