...
@Component({
  ...
  selector: 'app-LogHistoryByFilterRpt',
  templateUrl: './LogHistoryByFilterRpt.component.html',
})
export class LogHistoryByFilterRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
