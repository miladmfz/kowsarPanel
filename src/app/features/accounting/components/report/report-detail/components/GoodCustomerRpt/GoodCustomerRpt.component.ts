...
@Component({
  ...
  selector: 'app-GoodCustomerRpt',
  templateUrl: './GoodCustomerRpt.component.html',
})
export class GoodCustomerRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
