...
@Component({
  ...
  selector: 'app-HesabPeriodicForCustomerAndVendorRpt',
  templateUrl: './HesabPeriodicForCustomerAndVendorRpt.component.html',
})
export class HesabPeriodicForCustomerAndVendorRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
