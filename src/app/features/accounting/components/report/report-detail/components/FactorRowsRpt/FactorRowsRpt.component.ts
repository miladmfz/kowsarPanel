...
@Component({
  ...
  selector: 'app-FactorRowsRpt',
  templateUrl: './FactorRowsRpt.component.html',
})
export class FactorRowsRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
