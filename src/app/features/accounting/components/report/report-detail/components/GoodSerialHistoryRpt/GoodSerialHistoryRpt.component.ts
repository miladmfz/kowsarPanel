...
@Component({
  ...
  selector: 'app-GoodSerialHistoryRpt',
  templateUrl: './GoodSerialHistoryRpt.component.html',
})
export class GoodSerialHistoryRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
