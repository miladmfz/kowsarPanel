...
@Component({
  ...
  selector: 'app-PreFactorRowsRpt',
  templateUrl: './PreFactorRowsRpt.component.html',
})
export class PreFactorRowsRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
