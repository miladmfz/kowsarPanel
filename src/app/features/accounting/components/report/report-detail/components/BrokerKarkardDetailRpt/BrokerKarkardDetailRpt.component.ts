...
@Component({
  ...
  selector: 'app-BrokerKarkardDetailRpt',
  templateUrl: './BrokerKarkardDetailRpt.component.html',
})
export class BrokerKarkardDetailRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
