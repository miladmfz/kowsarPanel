...
@Component({
  ...
  selector: 'app-FactorsSanadStackRpt',
  templateUrl: './FactorsSanadStackRpt.component.html',
})
export class FactorsSanadStackRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
