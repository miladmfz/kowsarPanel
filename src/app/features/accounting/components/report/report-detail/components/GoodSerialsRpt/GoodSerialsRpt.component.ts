...
@Component({
  ...
  selector: 'app-GoodSerialsRpt',
  templateUrl: './GoodSerialsRpt.component.html',
})
export class GoodSerialsRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
