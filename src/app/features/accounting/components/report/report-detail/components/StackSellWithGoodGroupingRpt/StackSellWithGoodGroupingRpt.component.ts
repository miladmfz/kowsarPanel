...
@Component({
  ...
  selector: 'app-StackSellWithGoodGroupingRpt',
  templateUrl: './StackSellWithGoodGroupingRpt.component.html',
})
export class StackSellWithGoodGroupingRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
