...
@Component({
  ...
  selector: 'app-CashReceiveCheckRpt',
  templateUrl: './CashReceiveCheckRpt.component.html',
})
export class CashReceiveCheckRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
