...
@Component({
  ...
  selector: 'app-CashPaymentRpt',
  templateUrl: './CashPaymentRpt.component.html',
})
export class CashPaymentRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
