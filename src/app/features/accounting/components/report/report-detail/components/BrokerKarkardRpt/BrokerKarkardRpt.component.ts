...
@Component({
  ...
  selector: 'app-BrokerKarkardRpt',
  templateUrl: './BrokerKarkardRpt.component.html',
})
export class BrokerKarkardRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
