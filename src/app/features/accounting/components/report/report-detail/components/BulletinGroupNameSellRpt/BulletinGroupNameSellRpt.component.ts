...
@Component({
  ...
  templateUrl: './BulletinGroupNameSellRpt.component.html',
})
export class BulletinGroupNameSellRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
