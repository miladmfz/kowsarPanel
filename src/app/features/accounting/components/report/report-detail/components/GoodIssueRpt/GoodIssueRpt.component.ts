...
@Component({
  ...
  selector: 'app-GoodIssueRpt',
  templateUrl: './GoodIssueRpt.component.html',
})
export class GoodIssueRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
