...
@Component({
  ...
  selector: 'app-GoodCycleRpt',
  templateUrl: './GoodCycleRpt.component.html',
})
export class GoodCycleRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
