...
@Component({
  ...
  selector: 'app-TcPrintReturnFactorAttachedRpt',
  templateUrl: './TcPrintReturnFactorAttachedRpt.component.html',
})
export class TcPrintReturnFactorAttachedRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
