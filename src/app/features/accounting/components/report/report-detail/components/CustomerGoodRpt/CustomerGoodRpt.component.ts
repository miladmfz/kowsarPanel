...
@Component({
  ...
  selector: 'app-CustomerGoodRpt',
  templateUrl: './CustomerGoodRpt.component.html',
})
export class CustomerGoodRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
