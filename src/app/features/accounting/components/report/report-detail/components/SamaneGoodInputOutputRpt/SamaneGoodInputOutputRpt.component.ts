...
@Component({
  ...
  selector: 'app-SamaneGoodInputOutputRpt',
  templateUrl: './SamaneGoodInputOutputRpt.component.html',
})
export class SamaneGoodInputOutputRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
