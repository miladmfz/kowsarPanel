...
@Component({
  ...
  selector: 'app-GoodInStackVerticalRpt',
  templateUrl: './GoodInStackVerticalRpt.component.html',
})
export class GoodInStackVerticalRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
