...
@Component({
  ...
  selector: 'app-DailyWorkRpt',
  templateUrl: './DailyWorkRpt.component.html',
})
export class DailyWorkRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
