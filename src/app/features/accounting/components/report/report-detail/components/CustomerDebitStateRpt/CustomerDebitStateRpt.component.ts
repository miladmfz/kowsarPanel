...
@Component({
  ...
  selector: 'app-CustomerDebitStateRpt',
  templateUrl: './CustomerDebitStateRpt.component.html',
})
export class CustomerDebitStateRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
