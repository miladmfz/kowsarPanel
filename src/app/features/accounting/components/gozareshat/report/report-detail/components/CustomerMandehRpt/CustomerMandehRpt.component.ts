...
@Component({
  ...
  selector: 'app-CustomerMandehRpt',
  templateUrl: './CustomerMandehRpt.component.html',
})
export class CustomerMandehRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
