...
@Component({
  ...
  templateUrl: './GoodBulletinGroupSellRpt.component.html',
})
export class GoodBulletinGroupSellRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
