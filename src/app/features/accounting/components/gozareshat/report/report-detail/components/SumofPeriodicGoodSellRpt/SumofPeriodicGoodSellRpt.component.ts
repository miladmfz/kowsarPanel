...
@Component({
  ...
  templateUrl: './SumofPeriodicGoodSellRpt.component.html',
})
export class SumofPeriodicGoodSellRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
