...
@Component({
  ...
  selector: 'app-PersonGoodRpt',
  templateUrl: './PersonGoodRpt.component.html',
})
export class PersonGoodRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
