...
@Component({
  ...
  selector: 'app-PersonEtebarReceiveRpt',
  templateUrl: './PersonEtebarReceiveRpt.component.html',
})
export class PersonEtebarReceiveRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
