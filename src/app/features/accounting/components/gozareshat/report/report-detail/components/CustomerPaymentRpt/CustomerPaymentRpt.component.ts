...
@Component({
  ...
  selector: 'app-CustomerPaymentRpt',
  templateUrl: './CustomerPaymentRpt.component.html',
})
export class CustomerPaymentRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
