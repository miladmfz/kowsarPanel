...
@Component({
  ...
  selector: 'app-CashReceiveRpt',
  templateUrl: './CashReceiveRpt.component.html',
})
export class CashReceiveRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
