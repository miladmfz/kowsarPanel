...
@Component({
  ...
  selector: 'app-CustomerSponsorRpt',
  templateUrl: './CustomerSponsorRpt.component.html',
})
export class CustomerSponsorRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
