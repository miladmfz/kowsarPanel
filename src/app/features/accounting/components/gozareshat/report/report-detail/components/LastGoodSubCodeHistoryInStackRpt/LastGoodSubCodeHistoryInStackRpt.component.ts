...
@Component({
  ...
  selector: 'app-LastGoodSubCodeHistoryInStackRpt',
  templateUrl: './LastGoodSubCodeHistoryInStackRpt.component.html',
})
export class LastGoodSubCodeHistoryInStackRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
