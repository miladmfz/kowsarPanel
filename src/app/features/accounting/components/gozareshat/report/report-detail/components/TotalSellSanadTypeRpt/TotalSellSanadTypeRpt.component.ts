...
@Component({
  ...
  selector: 'app-TotalSellSanadTypeRpt',
  templateUrl: './TotalSellSanadTypeRpt.component.html',
})
export class TotalSellSanadTypeRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
  ...
  private initColumns(): void {
    ...
    this.repo.GetAllGridSchemaReport('T' + this.ReportData.ReportForm)
      .pipe(
        catchError((_error) => {
