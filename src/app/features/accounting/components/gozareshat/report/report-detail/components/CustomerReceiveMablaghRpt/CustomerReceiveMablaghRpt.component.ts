...
@Component({
  ...
  selector: 'app-CustomerReceiveMablaghRpt',
  templateUrl: './CustomerReceiveMablaghRpt.component.html',
})
export class CustomerReceiveMablaghRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
