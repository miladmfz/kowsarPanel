...
@Component({
  ...
  selector: 'app-PrefactorShortageRpt',
  templateUrl: './PrefactorShortageRpt.component.html',
})
export class PrefactorShortageRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
