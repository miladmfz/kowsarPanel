...
@Component({
  ...
  selector: 'app-TcPrintReturnPurchaseAttachedRpt',
  templateUrl: './TcPrintReturnPurchaseAttachedRpt.component.html',
})
export class TcPrintReturnPurchaseAttachedRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
