...
@Component({
  ...
  selector: 'app-GoodReceiptRpt',
  templateUrl: './GoodReceiptRpt.component.html',
})
export class GoodReceiptRptComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
