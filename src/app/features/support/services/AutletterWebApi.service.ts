...
export class AutletterWebApiService {
  ...
  GetLetterFromPersoninfo(
    ...
    return this.withLoading(this.client.get<any[]>(this.baseUrl + "GetLetterFromPersoninfo", { headers: this.headers, params: params }))
  }
  ...
  GetLetterRowList(
    ...
    return this.withLoading(this.client.get<any[]>(this.baseUrl + "GetLetterRowList", { headers: this.headers, params: params }))
  }
  ...
  GetAutConversation(
    ...
    const params = new HttpParams().append('LetterRef', LetterRef)
    return this.withLoading(this.client.get<any[]>(this.baseUrl + "GetAutConversation", { headers: this.headers, params: params }))
  }
  ...
  GetAutletterById(
    ...
    return this.withLoading(this.client.get<any[]>(this.baseUrl + "GetAutletterById", { headers: this.headers, params: params }))
  }



  SetAlarmOff(command): Observable<any[]> {
    return this.withLoading(this.client.post<any[]>(this.baseUrl + "SetAlarmOff", command, { headers: this.headers }))
  }

  Update_AutletterRow(command): Observable<any[]> {
    return this.withLoading(this.client.post<any[]>(this.baseUrl + "Update_AutletterRow", command, { headers: this.headers }))
  }
  ...
  Conversation_Insert(
    ...
    return this.withLoading(this.client.post<any[]>(this.baseUrl + "Conversation_Insert", { LetterRef, CentralRef, ConversationText }, { headers: this.headers }))
  }
  ...
  Conversation_UploadFile(command): Observable<any[]> {
    return this.withLoading(this.client.post<any[]>(this.baseUrl + "Conversation_UploadFile", command, { headers: this.headers }))
  }
  ...
  GetImageFileFromAttach(ObjectRef: string): Observable<any[]> {
    const params = new HttpParams().append('pixelScale', '1000').append('ClassName', 'Aut').append('ObjectRef', ObjectRef)
    return this.withLoading(this.client.get<any[]>(this.baseUrl + "GetImageFileFromAttach", { headers: this.headers, params: params }))

  }

  GetVoiceFileFromAttach(ObjectRef: string): Observable<any[]> {
    const params = new HttpParams().append('pixelScale', '1000').append('ClassName', 'Aut').append('ObjectRef', ObjectRef)
    return this.withLoading(this.client.get<any[]>(this.baseUrl + "GetVoiceFileFromAttach", { headers: this.headers, params: params }))

  }


  GetConversationFileFromAttach(command): Observable<any[]> {
    return this.withLoading(this.client.post<any[]>(this.baseUrl + "GetConversationFileFromAttach", command, { headers: this.headers }))
  }



  AttachFile_Insert(command): Observable<any[]> {
    return this.withLoading(this.client.post<any[]>(this.baseUrl + "AttachFile_Insert", command, { headers: this.headers }))
  }


  GetAttachFileList(command): Observable<any[]> {
    return this.withLoading(this.client.post<any[]>(this.baseUrl + "GetAttachFileList", command, { headers: this.headers }))
  }
  ...
  downloadFile(code: string, classname: string, ObjectRef: string): Observable<Blob> {
    ...
    return this.withLoading(this.client.get(url, {
      params: params,
      headers: headers,
  ...
  DeleteAutLetter(LetterCode: string): Observable<any[]> {
    const params = new HttpParams().append('LetterCode', LetterCode)
    return this.withLoading(this.client.get<any[]>(this.baseUrl + "DeleteAutLetter", { headers: this.headers, params: params }))
  }


  DeleteAutLetterRows(LetterRowCode: string): Observable<any[]> {
    const params = new HttpParams().append('LetterRowCode', LetterRowCode)
    return this.withLoading(this.client.get<any[]>(this.baseUrl + "DeleteAutLetterRows", { headers: this.headers, params: params }))
  }
  ...
  GetFactorByCustomerCode(command): Observable<any[]> {
    return this.withLoading(this.client.post<any[]>(this.baseUrl + "GetFactorByCustomerCode", command, { headers: this.headers }))
  }
