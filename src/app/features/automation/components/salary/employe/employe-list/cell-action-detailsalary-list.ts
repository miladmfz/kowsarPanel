...
export class CellActionDetailSalaryList implements ICellRendererAngularComp {
  // ---------------------------------------------------------------
  ...
  ShowDetailSalary(): void {
    this.params?.context?.componentParent?.ShowDetailSalary?.(this.params.data);
  }
