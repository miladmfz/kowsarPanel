...
import { CellActionAutletterCustomerList } from './cell-action-autletter-customer-list';

@Component({
  selector: 'app-autletter-customer-list',
  templateUrl: './autletter-customer-list.component.html',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
...
export class AutletterCustomerListComponent extends AgGridBaseComponent implements OnInit, OnDestroy {
    ...
    this.column_name_1 = [
      {
        field: 'عملیات',
        pinned: 'left',
        cellRenderer: CellActionAutletterCustomerList,
        cellRendererParams: { editUrl: '/automation/letter-detail' },
        minWidth: 80,
      },

      {
        field: 'HeaderLetterDate',
