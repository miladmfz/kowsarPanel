...
export const initialTheme = function () {
  /**
   * LeftSidebar
   * @param {*} $
   */
  !(function ($) {
    ...
    (LeftSidebar.prototype._reset = function () {
      ...
      (LeftSidebar.prototype.initLayout = function () {
        ...
        if (
          ...
          var sidebar = $.extend({}, layout ? layout.sidebar : {});
          var defaultSidebarSize =
            sidebar && sidebar.size ? sidebar.size : "default";
          var sidebarSize = self.body.attr("data-sidebar-size");
          this.changeSize(
            defaultSidebarSize
              ? defaultSidebarSize
    ...
    (function ($) {
      ...
      (RightBar.prototype.selectOptionsFromConfig = function () {
        ...
        if (config) {
          ...
          $(
            "input[type=checkbox][name=width][value=" + config.width + "]"
          ).prop("checked", true);
          $(
    ...
    (function ($) {
      ...
      (LayoutThemeApp.prototype.loadConfig = function () {
         ...
         * @param {*} mode
         */
        (LayoutThemeApp.prototype.changeMode = function (
          mode,
          notChangeSidebar
        ) {
          // sets the theme
          switch (mode) {
            case "dark": {
              ...
              if (notChangeSidebar) this._saveConfig({ mode: mode });
              else {
    ...
    (function ($) {
      ...
      (App.prototype.initControls = function () {
        ...
        (App.prototype.init = function () {
          ...
          if (
            document
              .getElementById("bs-default-stylesheet")
              .href.includes("bootstrap-rtl.min.css")
          ) {
